...
global GTP:=0,toggle:=0,bloodragetick_s:=0,bloodragetick_c:=0,RBtickS:=0,RBtickC:=0,XB1tickS:=0,XB1tickC:=0,EtickS:=0,EtickC:=0,CRunTickS:=10000,CRunTickC:=0
...
else if ((RBtickC<300) and (CRunTickS>4000))
{
	crun()
}
