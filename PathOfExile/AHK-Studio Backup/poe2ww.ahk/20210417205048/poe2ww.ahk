...
Run, *RunAs E:\Install\SystemFolders\Progs\Tools\nircmd\nircmdc.exe setappvolume /%ScriptPID% 0.3,, hide
SoundPlay, %A_WinDir%\Media\ding.wav

#Include _Preload.ahk
#Include D:\GoogleDrive\Documents\!NeedToSave\myScripts

global CoolDownFlask1:=6000
global CoolDownFlask2:=5900
global CoolDownFlask3:=6500
global CoolDownFlask4:=7400
global OnCoolDown:=[0,0,0,0]
global HotPot:=[S,D,F,G]
global AutoPot:=1
global GTP:=0
global toggle := 0
...
#IFWinActive ahk_class POEWindowClass
 ...
 ;*[poe2ww]
^WheelDown::Send {blind}{Right} ; ALT+WheelDown: Stash scroll 
^WheelUp::Send {blind}{Left} ; ALT+WheelUp: Stash scroll
...
else if (GetKeyState("e", "P"))
{
	...
	send t
else if (!GetKeyState("ALT", "P") and !GetKeyState("LButton", "P")) ;and !GetKeyState("RButton", "P"))
	;Click
	Send {blind}{LButton down}{LButton up}
