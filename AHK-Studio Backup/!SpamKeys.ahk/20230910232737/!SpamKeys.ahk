...
#IfWinActive ahk_exe MiniHealer.exe						;{
	...
	1:: 
	executeSequence("0x564637", 1451, 779, 7, , , 1451, 779,
	...
	executeSequence(ParamList*) {
		...
		Loop, % (ParamCount(ParamList) // 4) {
			waitPixClick(ParamList[A_Index*4-3], ParamList[A_Index*4-2], ParamList[A_Index*4-1], ParamList[A_Index*4], , , , ParamList[A_Index*4+1], ParamList[A_Index*4+2])
		}
