...
#IfWinActive ahk_exe MiniHealer.exe						;{
	...
	CapsLock::return
	F1::
	global preMposX:="",preMposY:="",rPixColor
	MouseGetPos, preMposX, preMposY
	waitPixClick("0x564637",1459, 810,1) ;564637
	waitPixClick("0x9F77D0",1672, 760,1,,false,1459, 810) ;564637
	/*
	...
	*/
	...
	waitPixClick("0x38100D",930, 999) ;38100D
	;PixelGetColor, rPixColor, 930, 999, RGB ;9F77D0	
	;MouseMove, 930, 999, 1
	;msgbox %rPixColor%
	MouseMove, preMposX, preMposY, 0
	return
	waitPixClick(rPixColor, x, y, clicks:=1, speed:=0,waitAndClick:=true,cwx:=00,cwy:=00)
	{
		if waitAndClick
		{
