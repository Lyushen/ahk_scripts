...
#IfWinActive ahk_class POEWindowClass		;*[Path of Exile] ;{
	;XButton2::Spam2("XButton2","LButton",100)
	;$~*XButton1::w
#IF ;}
#IfWinActive ahk_exe Chronicon.exe		;*[Chronicon] ;{
	F8::TogSpamTimerFunc("q","x","c",,,300,,0,0)
	XButton1::1
	XButton2::2
#IF ;}
...
#IfWinActive ahk_exe chrome.exe ;Number sender to phone, LFJ WORK ;{
	...
	;runwait, adb.exe "connect 192.168.1.115:5555"
	runwait, C:\platform-tools\adb.exe "shell input tap 542 2232"
	return
	F1::
	Ctmp := Clipboard
