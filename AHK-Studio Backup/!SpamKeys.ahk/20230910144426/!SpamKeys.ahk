...
#IfWinActive ahk_exe MiniHealer.exe						;{
	...
	PixelGetColor, rPixColor, 1459, 810, RGB ;564637
	
	
	;if rPixColor = 0x564637
		;MouseClick, Left,1459, 810, 5, 1
	PixelGetColor, rPixColor, 1672, 760, RGB ;9F77D0
	
	;if !rPixColor = 0x9F77D0
	;msgbox, aren't 5 gems
	waitForPix("0x564637",1474, 471)
	
	MouseMove, 1474, 471, 1
	msgbox %rPixColor%
	...
	return
	waitForPix(rPixColor,x,y,clicks:=1,speed:=1)
	{
		PixelGetColor, cPixColor, x, y, RGB ;564637		
		while (!cPixColor = rPixColor)
		{
			sleep 10
			PixelGetColor, cPixColor, x, y, RGB ;564637
			if cPixColor = rPixColor
			{
